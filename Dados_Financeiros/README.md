...
### 📍 KPI Situação das contas bancárias
...
### 📍 KPI Status das propostas de crédito
...
- Constata-se que o perfil dos clientes mudou em relação ao tipo de transações ao longo do tempo, clientes antigos realizaram menos transações e de valores mais baixos, enquanto clientes recentes realizaram mais transações e de valores mais altos. 
- Por outro lado, todos os perfis de clientes (jovem, adulto e melhor idade) apresentam transações em média da ordem R$200mil. Com exceção de alguns clientes adultos e da melhor idade que pontualmente fizeram transações da ordem de 300 a 400mil reais.
...
- Embora o banco digital tenha iniciado suas atividades apenas em 2015, ele apresenta grande adesão por parte dos clientes. Visto que a agência digital tem 460 contas e apresenta um saldo disponível nas contas da ordem de 250 mil reais. Enquanto as nove agências físicas concentram 539 contas com saldo disponível nas contas da ordem de 280 mil reais. Demonstrando que em poucos anos a agência digital ganhou muito adeptos.
- Observa-se que o saldo das contas tem ligação com a localidade, todavia esta variação é menor de R$100 mil. O estado com maior saldo é o Rio Grande do Sul (saldo de aproximadamente R$290 mil) e estado com menor saldo é Santa Catarina (saldo de aproximadamente R$230 mil).

### 📍 KPI Status das transações financeiras
- O dia da semana que tem, em média, maior volume de transações e maior valor movimentado é quinta-feira. Com valores da ordem de R$ 1,4 milhões e totalizando 21.120 transações.
- Enquanto a Segunda Quinzena tem, em média, maior volume de transações (R$ 2, 9 milhões), é a Primeira Quinzena que apresenta em média, maior volume de transações (47.293). Assim sendo, conclui-se que na Segunda Quinzena são realizadas menos transações (24.706) de valores mais altos. O montante da transação tem relação com período do dia que é executada, porque a noite (das 19 às 24h) os valores de transação são maiores (somatória R$ 1,6 milhões), enquanto de manhã (das 7 a 12h) os valores de transação são menores (somatória R$ 1,0 milhões). Sendo 50% maior o montante de transações da noite em relação a manhã. 
- Em relação as transações do tipo PIX, que começaram no final do ano 2020, elas passaram a ser a modalidade de envio e recebimento de dinheiro mais utilizadas, principalmente no mês de dezembro. Sendo que o DOC e o TED praticamente entraram em desuso de 2021 em diante. Por sua vez, a modalidade de compra de produtos e serviços mais utilizada foi compra no crédito, seguida por compra no débito. Fato que pode ser explicado pela facilidade nos últimos anos  dos clientes adquirirem cartões de crédito via conta digital. Além disso, pode se dever as fato de o banco oferecer um aplicativo com interface amigável, fato que incentiva os clientes a controlarem as compras e antecipar parcelas ganhando descontos na fatura do cartão.
...
Legenda: Distribuição dos diferentes tipos de transações pelos meses do ano (a esquerda) e no decorrer dos anos (a direita).

### 📍 KPI Status das propostas de crédito
- O tempo de vínculo com o banco dos clientes que pedem proposta financeira varia de 2 a 5 anos.
- E o Terceiro e Quarto Trimestre do ano concentram a grande maioria de número de envio da proposta de crédito e apresentam os maiores valores emprestados. Os cinco colaboradores com maior número propostas financeiras enviadas (da ordem de 1.000 propostas), com valores emprestados somados da ordem de R$58 milhões. E nota-se que os colaboradores com idade entre 30 e 60 anos concentram o maior volume de propostas.
- Em relação as agências, a Agência Digital é a agência com maior número de propostas de crédito enviada, da ordem de 1.000 propostas, com valor emprestado somado de R$ 411 milhões.
